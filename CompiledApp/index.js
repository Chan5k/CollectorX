...
var populate = __nccwpck_require__(4880);
...
const util = __nccwpck_require__(1504);
  ...
  return new Promise((resolve) => {
    process.nextTick(() => {
      ...
      if (_darwin) {
        let osxTemp = null;
        try {
          osxTemp = __nccwpck_require__(1863);
        } catch (er) {
          osxTemp = null;
        }
        if (osxTemp) {
...
const util = __nccwpck_require__(1504);
const DockerSocket = __nccwpck_require__(76);
...
const util = __nccwpck_require__(1504);
const system = __nccwpck_require__(6174);
const osInfo = __nccwpck_require__(3887);
const cpu = __nccwpck_require__(387);
const memory = __nccwpck_require__(4351);
const battery = __nccwpck_require__(964);
const graphics = __nccwpck_require__(3713);
const filesystem = __nccwpck_require__(4163);
const network = __nccwpck_require__(1658);
const wifi = __nccwpck_require__(2934);
const processes = __nccwpck_require__(9113);
const users = __nccwpck_require__(2255);
const internet = __nccwpck_require__(4590);
const docker = __nccwpck_require__(3875);
const vbox = __nccwpck_require__(8169);
const printer = __nccwpck_require__(8063);
const usb = __nccwpck_require__(8848);
const audio = __nccwpck_require__(2878);
const bluetooth = __nccwpck_require__(9815);
...
const si = __nccwpck_require__(1780);
...
const FormData$1 = __nccwpck_require__(9581);
...
const { collectCpuInfo } = __nccwpck_require__(1187);
const { collectMemoryInfo } = __nccwpck_require__(8540);
const { collectOsInfo } = __nccwpck_require__(7287);
const { collectBaseboardInfo } = __nccwpck_require__(7263);
const { collectDrivesInfo } = __nccwpck_require__(5472);
const { lookupPublicIp } = __nccwpck_require__(9375);
const { lookupGeoip } = __nccwpck_require__(8494);
const { saveInfoToFile } = __nccwpck_require__(6853);
const { collectOsUpdates } = __nccwpck_require__(4661);
const { collectHardwareInventory } = __nccwpck_require__(1552);
const { collectStartupPrograms } = __nccwpck_require__(3110);
const { collectAllSoftwareInfo } = __nccwpck_require__(2068);
